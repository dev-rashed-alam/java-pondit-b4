...
public class ReadingClass {
    ...
    /**
     * 1. Check a package
     * 2. Check if the content contains (.)
    ...
    private static void scanClasses(String packageName) throws IOException, URISyntaxException {
        ...
        while ((p = reader.readLine()) != null) {
            if (!p.isBlank() && p.contains(".class")) {
                ...
                var path = Paths.get(ClassLoader.getSystemClassLoader().getResource(uri).toURI());
